...
<head>
    ...
    <script>
        function validateEditProfile()
        {
            ...
            let mobile = document.eidtProfileForm.mobile.value;
            ...
            if(mobile != "")
            {
                ...
                {
                     alert("At least 11 numbers are required in mobile number");
                     return false;
                }
            }
        }
    ...
    <div class="center" >
        <div class="container" style="width: 450px;"> 
            ...
            <form name="eidtProfileForm" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" onsubmit="return validateEditProfile()">
                ...
                <input type="text" name="mobile" class="credentials" <?php echo "placeholder=".$mobile?>><p style="color:red" id="mobileErr"></p>  
                <br><hr>
